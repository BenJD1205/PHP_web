<?php
	...
	$sql =mysqli_query($conn, "select * from sanpham,category where category.category_id = sanpham.category_id and sanpham.category_id = '$id' ORDER BY sanpham.sanpham_id DESC"); 
	$sql_title =mysqli_query($conn, "select * from sanpham,category where category.category_id = sanpham.category_id and sanpham.category_id = '$id' ORDER BY sanpham.sanpham_id DESC");
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
								<?php
									while($row_sanpham = mysqli_fetch_array($sql,1)){	 
								?>
